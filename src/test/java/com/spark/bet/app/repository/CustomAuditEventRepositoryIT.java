package com.spark.bet.app.repository;

import com.spark.bet.app.FullSparkBetApp;
import com.spark.bet.app.config.Constants;
import com.spark.bet.app.config.audit.AuditEventConverter;
import com.spark.bet.app.domain.PersistentAuditEvent;
...
import static com.spark.bet.app.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
