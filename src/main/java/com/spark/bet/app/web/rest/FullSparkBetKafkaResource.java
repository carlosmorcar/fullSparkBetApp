...
@RestController
@RequestMapping("/api/full-spark-bet-kafka")
public class FullSparkBetKafkaResource {

    private final Logger log = LoggerFactory.getLogger(FullSparkBetKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public FullSparkBetKafkaResource(KafkaProperties kafkaProperties) {
